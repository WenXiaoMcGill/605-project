...
alpha1 = 60;
skirt1 = 0.0014;
phase1 = interval-floor(interval);%(center_f1/fs)*fs/fun_freq;
g1 = 1/10;
...
alpha2 = 80;
skirt2 = 0.0018;
phase2 = 0;%(center_f2/fs)*fs/fun_freq;
g2 = 0.0631/10;
...
alpha3 = 120;
skirt3 = 0.0027;
phase3 = 0;%(center_f3/fs)*fs/fun_freq;
g3 = 0.0316/10;
...
alpha5 = 200;
skirt5 = 0.0045;
phase5 = 0;%(center_f5/fs)*fs/fun_freq;
g5 = 0.001/10;
...
audiowrite('alto_e_205.wav', output, fs);