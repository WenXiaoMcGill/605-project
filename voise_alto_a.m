...
fun_freq = 205;                           % Fundamental frequency
...
alpha1 = 80;
skirt1 = 0.0018;
phase1 = (center_f1/fs)*fs/fun_freq;
g1 = 1/10;
...
alpha2 = 90;
skirt2 = 0.002;
phase2 = (center_f2/fs)*fs/fun_freq;
g2 = 0.6310/10;
...
alpha3 = 120;
skirt3 = 0.0027;
phase3 = (center_f3/fs)*fs/fun_freq;
g3 = 0.1/10;
...
alpha4 = 130;
skirt4 = 0.0029;
phase4 = (center_f4/fs)*fs/fun_freq;
g4 = 0.0158/10;
...
alpha5 = 140;
skirt5 = 0.0032;
phase5 = (center_f5/fs)*fs/fun_freq;
g5 = 0.001/10;
...
%}
%plot(output(1:1500))
%audiowrite('alto_a_205.wav', output, fs);